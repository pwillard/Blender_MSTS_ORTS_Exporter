...
REVISION HISTORY
2024-04-02      Released V5.0  - pkw - Blender Version 4.1 changes how autosmooth works, and the exporter now uses the new API for smoothing (Mesh.normal_split is deprecated and removed)
